<?php
App::uses('DDMigration', 'Lib');
class Xero extends DDMigration {
 ...
 */
	public $migration = array(
		'up' => array(
			'create_table' => array(
				...
				'xero_requests' => array(
					...
					'endpoint' => array('type'=>'string', 'null' => true, 'length' => 255, 'collate' => 'latin1_swedish_ci', 'charset' => 'latin1'),
					'query' => array('type'=>'string', 'null' => true, 'length' => 255, 'collate' => 'latin1_swedish_ci', 'charset' => 'latin1'),
		...
		'down' => array(
			'drop_table' => array(
				'xero_credentials', 'xero_requests'
			),
		),
	);
